...
"""Microsoft Intune Device Configurations telemetry scanner data pipeline."""
...
def run_device_configs_pipeline(
    client_id: str,
    client_secret: str,
    tenant_id: str,
    endpoint_name: str,
    ...
    """Fetch Intune configuration policies from Graph beta endpoint."""
    client = GraphClient(
        tenant_id=tenant_id,
