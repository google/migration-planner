...
"""Retention Policies PowerShell scanner data pipeline."""
...
def run_retention_policies_pipeline(
    client_id: str,
    client_secret: str,
    tenant_id: str
) -> list:
    """Fetch retention policies via PowerShell."""
    ...
    ret_service = RetentionService(ps_client)
    return ret_service.fetch_retention_policies()
