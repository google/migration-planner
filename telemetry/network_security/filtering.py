...
"""UI frame for Global Secure Access Filtering policies."""
...
usage_logger = logging.getLogger("M365TelemetryAsyncLogger.FilteringPoliciesUI")

class FilteringPoliciesSubFrame(ctk.CTkFrame):
    """Sub-frame for Global Secure Access Filtering Policies."""
    ...
    def build_ui(self):
        ...
        self.btn_export = ctk.CTkButton(
            self.header_frame, text="Export Filtering Policies", width=200, height=32, corner_radius=16,
    ...
    def trigger_fetch(self, tenant, client_id, client_secret):
        ...
        self.csv_path = os.path.join(reports_dir, "network_filtering_policies.csv")

        self._set_loading_state("Scanning Entra filtering policies...")
    ...
    def _update_grid(self):
        ...
        for row_idx, item in enumerate(page_data, start=1):
            ...
            col_keys = ["name", "description", "version", "action", "rules_count"]
    ...
    def _export(self):
        ...
        dest_path = filedialog.asksaveasfilename(
            ...
            title="Export Filtering Policies CSV",
            initialfile="M365_Secure_Access_Filtering.csv",
            parent=self
        )
        ...
        try:
            ...
            messagebox.showinfo("Export Successful", f"Filtering Policies successfully exported to:\n{dest_path}")
        except Exception as e:
