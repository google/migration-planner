...
"""UI frame for Intune Firewall and Proxy configurations."""
...
usage_logger = logging.getLogger("M365TelemetryAsyncLogger.FirewallUI")

class FirewallSubFrame(ctk.CTkFrame):
    """Sub-frame for Intune Firewall & Proxy configuration settings."""
    ...
    def build_ui(self):
        ...
        ctk.CTkLabel(self.header_frame, text="3. Firewall and Proxy Configurations", font=FONT_HEADER_SMALL, text_color=COLOR_TEXT_MAIN).pack(side="left")
        ...
        self.btn_export = ctk.CTkButton(
            self.header_frame, text="Export Firewall & Proxy Configs", width=200, height=32, corner_radius=16,
    ...
    def trigger_fetch(self, tenant, client_id, client_secret):
        ...
        self.csv_path = os.path.join(reports_dir, "network_firewall_policies.csv")

        self._set_loading_state("Scanning Intune Firewall and Proxy configurations...")
    ...
    def _update_grid(self):
        ...
        for row_idx, item in enumerate(page_data, start=1):
            ...
            col_keys = ["name", "policy_type", "firewall_status", "proxy_status"]
    ...
    def _export(self):
        ...
        dest_path = filedialog.asksaveasfilename(
            ...
            title="Export Firewall & Proxy Configs CSV",
            initialfile="M365_Firewall_Proxy_Configs.csv",
            parent=self
        )
        ...
        try:
            ...
            messagebox.showinfo("Export Successful", f"Firewall & Proxy Configurations successfully exported to:\n{dest_path}")
        except Exception as e:
