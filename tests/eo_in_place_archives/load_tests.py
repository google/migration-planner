...
class TestEOInPlaceArchiveLoad(unittest.TestCase):
    ...
    def test_load_simulation(self):
        ...
        print(f"Starting load test for {len(user_ids)} users (Simulate Failures: {self.simulate_failures})...")
    ...
    def test_flakiness(self):
        ...
        print(f"\nStarting flakiness test ({n_runs} runs)...")
        ...
        print("Flakiness test passed: All runs yielded identical results and respected quotas.")
