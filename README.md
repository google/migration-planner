...
- The progress screen would have three progress bars:
  - **Site Discovery**: This progress bar will report the progress while scanning all the sites/subsites in the tenant under the root site.
  ...
  - **Metrics Calculation**: This will show the progress of the metrics (like max depth, folder count, file distributions, etc.) for the drives.
...
- **Site Discovery** and **Drive Discovery** phases in the progress screen would have indeterminate progress bars as the total number of sites/folders/files are not known during those phases.
